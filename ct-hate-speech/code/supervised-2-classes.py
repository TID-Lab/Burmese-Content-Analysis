...
if __name__ == "__main__":
    dir_path = "/home/harshil/Harshil/gt/spring2020/research2/burmese-NLP/ct-hate-speech"
    CUSTOM_SEED=42
    ...
    # print(recalls)
    # print(accuracies)
    plt.title("Majority class undersampling trends in Perf metrics (only segmented unicode)", fontsize=16)
    ...
    plt.gca().set_xlabel("Training Size(Majority class size undersampled)", fontsize=14)
    plt.gca().set_ylabel("Test data performance measures", fontsize=14)
    plt.legend()
    plt.show()
    plt.savefig(os.path.join(dir_path, "graphs/undersampling_seg_uni_svm.png")
