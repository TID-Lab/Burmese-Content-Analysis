...
if __name__ == "__main__":
    ...
    src_file = "data/crowdtangle/ct_michael/ct_formatted.txt"
    target_file = "data/crowdtangle/ct_michael/ct_segmented.txt"
    analysis_file = "data/crowdtangle/ct_michael/ct_analysis.txt" 
